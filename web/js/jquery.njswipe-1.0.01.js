...
jQuery.fn.extend({
    njSwipe: function (direction, callback) {
        ...
        this.bindEvents = function () { 
            ...
            $(this).on('mousemove', this.touchMove);
        ...
        this.touchStart = function (e) {
            ...
            var touch = e.originalEvent.type == 'touchstart' ? e.originalEvent.touches[0] || e.originalEvent.changedTouches[0] : e;
        ...
        this.touchEnd = function (e) {
            ...
            var touch = e.originalEvent.type == 'touchend' ? e.originalEvent.touches[0] || e.originalEvent.changedTouches[0] : e;
